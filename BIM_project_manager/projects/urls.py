...
urlpatterns = [
  ...
  path('<int:pk>/export/<str:export_type>', views.BimProjectExporter.as_view(), name='project_exporter'),
  ...
  path('models/<int:pk>/export/<str:export_type>', views.BimModelExporter.as_view(), name='model_exporter'),
