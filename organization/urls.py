...
urlpatterns = [
    ...
    path('export_organization_data', views.OrganizationDataExporter.as_view(), name='export_organization_data'),
    path('import_organization_data', views.OrganizationDataImporter.as_view(), name='import_organization_data'),
]
